...
const jseAds = {
	 ...
	 */
	logAdStat: async(selectedAd,impression) => {
		const rightNow = new Date();
		const yymmdd = rightNow.toISOString().slice(2,10).replace(/-/g,""); // could be done with setInterval
		jseAds.addProperty(`adxAdvStats/${selectedAd.advID}/${yymmdd}/${selectedAd.cid}/${impression}`,1);
		jseAds.addProperty(`adxAdvDomains/${selectedAd.advID}/${yymmdd}/${selectedAd.cid}/${selectedAd.domain}/${impression}`,1);
		jseAds.addProperty(`adxAdvPubIDs/${selectedAd.advID}/${yymmdd}/${selectedAd.cid}/${selectedAd.pubID}/${impression}`,1);
		jseAds.addProperty(`adxAdvCreatives/${selectedAd.advID}/${yymmdd}/${selectedAd.cid}/${selectedAd.fileName}/${impression}`,1);
		jseAds.addProperty(`adxAdvGeos/${selectedAd.advID}/${yymmdd}/${selectedAd.cid}/${selectedAd.geo}/${impression}`,1);
		jseAds.addProperty(`adxAdvDevices/${selectedAd.advID}/${yymmdd}/${selectedAd.cid}/${selectedAd.device}/${impression}`,1);
		jseAds.addProperty(`adxAdvBrowsers/${selectedAd.advID}/${yymmdd}/${selectedAd.cid}/${selectedAd.browser}/${impression}`,1);

		jseAds.addProperty(`adxPubStats/${selectedAd.pubID}/${yymmdd}/${selectedAd.siteID}/${impression}`,1);
		jseAds.addProperty(`adxPubDomains/${selectedAd.pubID}/${yymmdd}/${selectedAd.siteID}/${selectedAd.domain}/${impression}`,1);
		jseAds.addProperty(`adxPubSubIDs/${selectedAd.pubID}/${yymmdd}/${selectedAd.siteID}/${selectedAd.subID}/${impression}`,1);
		jseAds.addProperty(`adxPubAdvIDs/${selectedAd.pubID}/${yymmdd}/${selectedAd.siteID}/${selectedAd.advID}/${impression}`,1);
		jseAds.addProperty(`adxPubGeos/${selectedAd.pubID}/${yymmdd}/${selectedAd.siteID}/${selectedAd.geo}/${impression}`,1);
		jseAds.addProperty(`adxPubDevices/${selectedAd.pubID}/${yymmdd}/${selectedAd.siteID}/${selectedAd.device}/${impression}`,1);
		jseAds.addProperty(`adxPubPlacements/${selectedAd.pubID}/${yymmdd}/${selectedAd.siteID}/${selectedAd.browser}/${impression}`,1);

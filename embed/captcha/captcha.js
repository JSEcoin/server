...
JSECaptcha = (function() {
  ...
  #JSE-captcha-container { all: revert; position: relative; background: #FFF; border: 1px solid #EEE; border-radius: 3px; width: 220px; height: 40px; font-size: 15px; font-family: Arial, sans-serif; color: #777; }\
  #JSE-captcha-tick { text-align: center; color: #1687e9; font-size: 17px; line-height: 22px; vertical-align: middle; height: 22px; width: 22px; background: #FFF; border: 2px solid #CCC; border-radius: 2px; margin: 8px; cursor: pointer; }\
  ...
  this.tick = function() {
    ...
    document.getElementById('JSE-captcha-tick').innerHTML = '<img style="height: 18px; margin-top: 2px; -webkit-touch-callout: none; -webkit-user-select: none; -khtml-user-select: none; -moz-user-select: none; -ms-user-select: none; user-select: none;" draggable="false" src="'+robotFace+'" />';
  ...
  this.shrink = function() {
    var miniShrink = function() {
      ...
      if (!allDone) {
        ...
        document.getElementById('JSE-captcha-tick').innerHTML = '<img style="height: 18px; margin-top: 2px;" draggable="false" src="'+wink+'" />';
        document.getElementById('JSE-captcha-tick').onmousedown = function() { return false; };
      }
    }
    miniShrink();

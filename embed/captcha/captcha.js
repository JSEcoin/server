...
JSECaptcha = (function() {
  ...
  var css = '  #JSE-captcha-reset { all: initial; box-sizing: content-box !important; vertical-align: top !important; }\
  ...
  #JSE-captcha-tick { text-align: center; color: #1687e9; font-size: 17px; height: 20px; width: 20px; background: #FFF; border: 2px solid #CCC; border-radius: 2px; margin: 6px 0px 0px 8px; cursor: pointer; vertical-align: top !important; box-sizing: content-box; padding-top: 3px; }\

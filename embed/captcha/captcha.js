...
JSECaptcha = (function() {
  ...
  var css = '  #JSE-captcha-reset { all: initial; box-sizing: border-box; vertical-align: top; }\
  ...
  #JSE-captcha-tick { text-align: center; color: #1687e9; font-size: 17px; height: 22px; width: 22px; background: #FFF; border: 2px solid #CCC; border-radius: 2px; margin: 8px; cursor: pointer; }\
  ...
  this.tick = function() {
    ...
    document.getElementById('JSE-captcha-tick').innerHTML = '<img style="height: 18px; padding: 1px; -webkit-touch-callout: none; -webkit-user-select: none; -khtml-user-select: none; -moz-user-select: none; -ms-user-select: none; user-select: none;" draggable="false" src="'+robotFace+'" />';
  ...
  this.shrink = function() {
    var miniShrink = function() {
      ...
      if (!allDone) {
        ...
        document.getElementById('JSE-captcha-tick').innerHTML = '<img style="height: 18px; padding: 1px;" draggable="false" src="'+wink+'" />';
        document.getElementById('JSE-captcha-tick').onmousedown = function() { return false; };
      }
    }
    miniShrink();

...
JSECaptcha = (function() {
  ...
  #JSE-captcha-tick { text-align: center; color: #1687e9; font-size: 17px; line-height: 22px; height: 22px; width: 22px; background: #FFF; border: 2px solid #CCC; border-radius: 2px; margin: 8px; cursor: pointer; }\
